...
export const LinearReference = $root.LinearReference = (() => {
     ...
     * @member {number|Long|null|undefined} endDistance
     * @memberof LinearReference
     * @instance
     */
    LinearReference.prototype.endDistance = null;
    ...
    LinearReference.encode = function encode(message, writer) {
        ...
        if (message.startDistance != null && Object.hasOwnProperty.call(message, "startDistance"))
            writer.uint32(/* id 1, wireType 0 =*/8).uint64(message.startDistance);
        if (message.endDistance != null && Object.hasOwnProperty.call(message, "endDistance"))
    ...
    LinearReference.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LinearReference();
    ...
    LinearReference.fromObject = function fromObject(object) {
        if (object instanceof $root.LinearReference)
            return object;
        let message = new $root.LinearReference();
    ...
    /**
     * Gets the default type url for LinearReference
     * @function getTypeUrl
     * @memberof LinearReference
     * @static
     ...
     */
    LinearReference.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/LinearReference";
    };

    return LinearReference;
})();

export const SharedStreetsLinearReferences = $root.SharedStreetsLinearReferences = (() => {
    ...
    SharedStreetsLinearReferences.encode = function encode(message, writer) {
        ...
        if (message.referenceLength != null && Object.hasOwnProperty.call(message, "referenceLength"))
    ...
    SharedStreetsLinearReferences.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SharedStreetsLinearReferences();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    SharedStreetsLinearReferences.verify = function verify(message) {
        ...
        if (message.references != null && message.hasOwnProperty("references")) {
            ...
            for (let i = 0; i < message.references.length; ++i) {
                let error = $root.LinearReference.verify(message.references[i]);
                if (error)
    ...
    SharedStreetsLinearReferences.fromObject = function fromObject(object) {
        if (object instanceof $root.SharedStreetsLinearReferences)
            return object;
        let message = new $root.SharedStreetsLinearReferences();
    ...
    /**
     * Gets the default type url for SharedStreetsLinearReferences
     * @function getTypeUrl
     * @memberof SharedStreetsLinearReferences
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    SharedStreetsLinearReferences.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/SharedStreetsLinearReferences";
    };

    return SharedStreetsLinearReferences;
})();

export const DataBin = $root.DataBin = (() => {
    ...
    DataBin.encode = function encode(message, writer) {
        ...
        if (message.dataType != null && message.dataType.length)
            for (let i = 0; i < message.dataType.length; ++i)
    ...
    DataBin.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DataBin();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    DataBin.toObject = function toObject(message, options) {
        ...
        if (message.dataType && message.dataType.length) {
            object.dataType = [];
            for (let j = 0; j < message.dataType.length; ++j)
    ...
    /**
     * Gets the default type url for DataBin
     * @function getTypeUrl
     * @memberof DataBin
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    DataBin.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/DataBin";
    };

    return DataBin;
})();

export const BinnedPeriodicData = $root.BinnedPeriodicData = (() => {
    ...
    BinnedPeriodicData.encode = function encode(message, writer) {
        ...
        if (message.periodOffset != null && message.periodOffset.length) {
            ...
            for (let i = 0; i < message.periodOffset.length; ++i)
    ...
    BinnedPeriodicData.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.BinnedPeriodicData();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    BinnedPeriodicData.verify = function verify(message) {
        ...
        if (message.bins != null && message.hasOwnProperty("bins")) {
            ...
            for (let i = 0; i < message.bins.length; ++i) {
                let error = $root.DataBin.verify(message.bins[i]);
                if (error)
                    return "bins." + error;
            }
        }
    ...
    BinnedPeriodicData.toObject = function toObject(message, options) {
        ...
        if (message.periodOffset && message.periodOffset.length) {
            object.periodOffset = [];
            for (let j = 0; j < message.periodOffset.length; ++j)
    ...
    /**
     * Gets the default type url for BinnedPeriodicData
     * @function getTypeUrl
     * @memberof BinnedPeriodicData
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    BinnedPeriodicData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/BinnedPeriodicData";
    };

    return BinnedPeriodicData;
})();

export const SharedStreetsBinnedLinearReferences = $root.SharedStreetsBinnedLinearReferences = (() => {
    ...
    SharedStreetsBinnedLinearReferences.encode = function encode(message, writer) {
        ...
        if (message.referenceId != null && Object.hasOwnProperty.call(message, "referenceId"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.referenceId);
        if (message.scaledCounts != null && Object.hasOwnProperty.call(message, "scaledCounts"))
        ...
        if (message.numberOfBins != null && Object.hasOwnProperty.call(message, "numberOfBins"))
        ...
        if (message.binPosition != null && message.binPosition.length) {
            ...
            for (let i = 0; i < message.binPosition.length; ++i)
    ...
    SharedStreetsBinnedLinearReferences.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SharedStreetsBinnedLinearReferences();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    SharedStreetsBinnedLinearReferences.fromObject = function fromObject(object) {
        if (object instanceof $root.SharedStreetsBinnedLinearReferences)
            return object;
        let message = new $root.SharedStreetsBinnedLinearReferences();
        if (object.referenceId != null)
            message.referenceId = String(object.referenceId);
        ...
        if (object.binPosition) {
            ...
            message.binPosition = [];
            for (let i = 0; i < object.binPosition.length; ++i)
    ...
    SharedStreetsBinnedLinearReferences.toObject = function toObject(message, options) {
        ...
        if (message.binPosition && message.binPosition.length) {
            object.binPosition = [];
            for (let j = 0; j < message.binPosition.length; ++j)
    ...
    /**
     * Gets the default type url for SharedStreetsBinnedLinearReferences
     * @function getTypeUrl
     * @memberof SharedStreetsBinnedLinearReferences
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    SharedStreetsBinnedLinearReferences.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/SharedStreetsBinnedLinearReferences";
    };
...
export const SharedStreetsWeeklyBinnedLinearReferences = $root.SharedStreetsWeeklyBinnedLinearReferences = (() => {
    ...
    SharedStreetsWeeklyBinnedLinearReferences.encode = function encode(message, writer) {
        ...
        if (message.binnedPeriodicData != null && message.binnedPeriodicData.length)
            for (let i = 0; i < message.binnedPeriodicData.length; ++i)
    ...
    SharedStreetsWeeklyBinnedLinearReferences.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SharedStreetsWeeklyBinnedLinearReferences();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    SharedStreetsWeeklyBinnedLinearReferences.verify = function verify(message) {
        ...
        if (message.binnedPeriodicData != null && message.hasOwnProperty("binnedPeriodicData")) {
            ...
            for (let i = 0; i < message.binnedPeriodicData.length; ++i) {
                let error = $root.BinnedPeriodicData.verify(message.binnedPeriodicData[i]);
                if (error)
    ...
    SharedStreetsWeeklyBinnedLinearReferences.fromObject = function fromObject(object) {
        if (object instanceof $root.SharedStreetsWeeklyBinnedLinearReferences)
            return object;
        let message = new $root.SharedStreetsWeeklyBinnedLinearReferences();
        if (object.referenceId != null)
            message.referenceId = String(object.referenceId);
        ...
        if (object.binnedPeriodicData) {
            ...
            message.binnedPeriodicData = [];
            for (let i = 0; i < object.binnedPeriodicData.length; ++i) {
    ...
    SharedStreetsWeeklyBinnedLinearReferences.toObject = function toObject(message, options) {
        ...
        if (message.binnedPeriodicData && message.binnedPeriodicData.length) {
            object.binnedPeriodicData = [];
            for (let j = 0; j < message.binnedPeriodicData.length; ++j)
    ...
    /**
     * Gets the default type url for SharedStreetsWeeklyBinnedLinearReferences
     * @function getTypeUrl
     * @memberof SharedStreetsWeeklyBinnedLinearReferences
     * @static
     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
     * @returns {string} The default type url
     */
    SharedStreetsWeeklyBinnedLinearReferences.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/SharedStreetsWeeklyBinnedLinearReferences";
    };
